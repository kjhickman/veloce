...
public class UndoMoveBenchmarks
{
    ...
    {
        _quietMovePosition.UndoMove();
    }

    [Benchmark]
    public void UndoDoublePawnPushMove()
    {
        _doublePawnPushMovePosition.UndoMove();
    }

    [Benchmark]
    public void UndoCaptureMove()
    {
        _captureMovePosition.UndoMove();
    }

    [Benchmark]
    public void UndoCastlingMove()
    {
        _castlingMovePosition.UndoMove();
    }

    [Benchmark]
    public void UndoEnPassantMove()
    {
        _enPassantMovePosition.UndoMove();
    }

    [Benchmark]
    public void UndoPromotionMove()
    {
        _promotionMovePosition.UndoMove();
    }
}
