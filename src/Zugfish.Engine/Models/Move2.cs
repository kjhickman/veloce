...
public struct Move : IEquatable<Move>
{
    ...
    public static Move CreateEnPassant(Square from, Square to, PieceType pieceType)
    {
        return new Move(from, to, PromotedPieceType.None, pieceType, PieceType.None, true, SpecialMoveType.EnPassant);
    }

    public static Move CreateEnPassant(Square from, Square to, PieceType pieceType, PieceType capturedPieceType)
    {
